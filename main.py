...
pygame.display.set_caption("Spunky Shooter")
...
def yellow_handle_movement(keys_pressed,yellow):
        if keys_pressed[pygame.K_a] and yellow.x - VEL > BORDER.x:
            yellow.x -= VEL
        if keys_pressed[pygame.K_d] and yellow.x + VEL + SPACESHIP_WIDTH < WIDTH:
            yellow.x += VEL
...
def red_handle_movement(keys_pressed,red):
        if keys_pressed[pygame.K_LEFT] and red.x - VEL > 0:
            red.x -= VEL
        if keys_pressed[pygame.K_RIGHT] and red.x + VEL + SPACESHIP_WIDTH < BORDER.x:
            red.x += VEL
